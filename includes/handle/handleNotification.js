...
module.exports = function ({ api }) {
	...
	try {
        ...
        //   console.log(i)
				...
				for (const i of data.notifications_page.edges) {
					...
					const body = i.node.notif.body.text;
					const link = i.node.notif.url;
					const timestemp = i.node.notif.creation_time.timestamp;
